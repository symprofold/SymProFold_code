...
conf.set_species('Tthi', 'Thermococcus thioreducens')
conf.set_gene('A0A0Q2M111')
conf.import_domains()
...
for conformation in  conf.conformations:
    ...
    ax[0].set_folder('A0A0Q2M111_23x6/', 1) # set oriented path
    ax[0].set_surface([ [295,387] ])

    ax[1].set_session(sess, conf)
    ax[1].set_folder('A0A0Q2M111_x2/', 2) # set oriented path
    ax[1].set_surface([ [1,294], [388,1000] ]) 
